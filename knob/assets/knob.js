...
var _user$project$Knob$view = function (model) {
	...
	var y2 = c + (ar * _elm_lang$core$Basics$sin(offset + target));
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$svg$Svg_Attributes$cx(sC),
								_elm_lang$svg$Svg_Attributes$cy(sC),
								_elm_lang$svg$Svg_Attributes$r('23'),
								_elm_lang$svg$Svg_Attributes$class('outer')
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$svg$Svg_Attributes$class('gauge'),
								_elm_lang$svg$Svg_Attributes$d(m)
							]),
						_elm_lang$core$Native_List.fromArray(
							[])),
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$svg$Svg_Attributes$class('inner')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
...
var Elm = {};
Elm['Knob'] = Elm['Knob'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Knob'], 'Knob', typeof _user$project$Knob$main === 'undefined' ? null : _user$project$Knob$main);
