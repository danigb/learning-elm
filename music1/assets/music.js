...
var _user$project$Ports$loaded = _elm_lang$core$Native_Platform.incomingPort('loaded', _elm_lang$core$Json_Decode$string);
var _user$project$Ports$play = _elm_lang$core$Native_Platform.outgoingPort(
	'play',
	function (v) {
		return v;
	});
var _user$project$Ports$schedule = _elm_lang$core$Native_Platform.outgoingPort(
	'schedule',
	function (v) {
		return _elm_lang$core$Native_List.toArray(v).map(
			function (v) {
				return {time: v.time, note: v.note};
			});
	});
var _user$project$Ports$Event = F2(
	function (a, b) {
...
var _user$project$Music$randomList = function (n) {
	return A2(
		...
		n,
		A2(_elm_lang$core$Random$int, 40, 90));
};
var _user$project$Music$chromatic = A2(
	_elm_lang$core$List$append,
	...
	function (dur, notes) {
		return A2(
			...
			F2(
				function (i, n) {
					return A2(
						_user$project$Ports$Event,
						dur * _elm_lang$core$Basics$toFloat(i),
						n);
				}),
			notes);
	});
var _user$project$Music$Model = F3(
	function (a, b, c) {
...
var _user$project$Music$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'NewSeed':
			...
			case 'Loaded':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{ready: true, inst: _p0._0}),
					_1: _user$project$Ports$play('a3')
				};
			case 'ChromaticExample':
				return {
					ctor: '_Tuple2',
					_0: model,
...
var _user$project$Music$RandomExample = {ctor: 'RandomExample'};
var _user$project$Music$ChromaticExample = {ctor: 'ChromaticExample'};
var _user$project$Music$view = function (model) {
	var viewLoaded = function (name) {
		return A2(
				...
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							A2(_elm_lang$core$Basics_ops['++'], 'Instrument: ', name))
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							...
							_elm_lang$html$Html_Events$onClick(_user$project$Music$ChromaticExample)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('chromatic')
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$href('#'),
							_elm_lang$html$Html_Events$onClick(_user$project$Music$RandomExample)
						]),
					_elm_lang$core$Native_List.fromArray(
						[
	...
	var viewLoading = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Loading piano...')
			]));
	var viewHead = A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html$text('Elm music1 example')
			]));
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				viewHead,
				model.ready ? viewLoaded(model.inst) : viewLoading
			]));
};
var _user$project$Music$Loaded = function (a) {
	return {ctor: 'Loaded', _0: a};
};
var _user$project$Music$subscriptions = function (model) {
	return _user$project$Ports$loaded(_user$project$Music$Loaded);
};
var _user$project$Music$NewSeed = function (a) {
	return {ctor: 'NewSeed', _0: a};
};
var _user$project$Music$getCurrentSecs = function () {
	var timeToSeed = function (t) {
	...
	return A3(
		...
		function (_p1) {
			return _user$project$Music$NewSeed(
				timeToSeed(0));
		},
		function (t) {
			return _user$project$Music$NewSeed(
...
var _user$project$Music$init = {
	...
	_1: _user$project$Music$getCurrentSecs
};
var _user$project$Music$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Music$init, view: _user$project$Music$view, update: _user$project$Music$update, subscriptions: _user$project$Music$subscriptions})
};

var Elm = {};
Elm['Music'] = Elm['Music'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Music'], 'Music', typeof _user$project$Music$main === 'undefined' ? null : _user$project$Music$main);
