...
var _user$project$Circles$freq = function (seed) {
	return _elm_lang$core$Basics$toFloat(seed) * 100.0;
};
var _user$project$Circles$tick = function (model) {
	var updated = A2(
		_elm_lang$core$List$map,
		function (c) {
	...
	var remaining = A2(
		...
		function (c) {
			return _elm_lang$core$Native_Utils.cmp(c.r, 0) > 0;
		},
		updated);
	return _elm_lang$core$Native_Utils.update(
		model,
...
var _user$project$Circles$getClickPos = A3(
	...
	A2(
		...
		_elm_lang$core$Native_List.fromArray(
			['offsetY']),
		_elm_lang$core$Json_Decode$int));
var _user$project$Circles$pick = F2(
	function (i, list) {
...
var _user$project$Circles$colors = _elm_lang$core$Native_List.fromArray(
	['#DBFFF2', '#05668D', '#028090', '#00A896', '#02C39A', '#F0F3BD']);
var _user$project$Circles$color = function (circle) {
	return A2(_user$project$Circles$pick, circle.seed, _user$project$Circles$colors);
};
var _user$project$Circles$viewCircle = function (circle) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					'fill:',
					_user$project$Circles$color(circle)))
			]),
		_elm_lang$core$Native_List.fromArray(
			[]));
};
var _user$project$Circles$Circle = F4(
	function (a, b, c, d) {
...
var _user$project$Circles$init = {
	ctor: '_Tuple2',
	_0: {
...
var _user$project$Circles$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second / 60, _user$project$Circles$Tick);
};
var _user$project$Circles$AddCircle = function (a) {
	return {ctor: 'AddCircle', _0: a};
};
var _user$project$Circles$onClick = A2(
	_elm_lang$html$Html_Events$on,
	'click',
	A2(_elm_lang$core$Json_Decode$map, _user$project$Circles$AddCircle, _user$project$Circles$getClickPos));
var _user$project$Circles$view = function (model) {
	var circles = A2(_elm_lang$core$List$map, _user$project$Circles$viewCircle, model.circles);
	var bg = A2(
...
var _user$project$Circles$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Circles$init, view: _user$project$Circles$view, update: _user$project$Circles$update, subscriptions: _user$project$Circles$subscriptions})
};

var Elm = {};
Elm['Circles'] = Elm['Circles'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Circles'], 'Circles', typeof _user$project$Circles$main === 'undefined' ? null : _user$project$Circles$main);
