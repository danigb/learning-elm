...
type alias Model = { label: String, min: Float, max: Float, value: Float, drag: Maybe Drag }
...
init : (Model, Cmd Msg)
init = (Model "Gain" 0 100 50 Nothing, Cmd.none)
...
view model =
  ...
  in
    Html.div [Attr.class "knob"] [
      Html.div [Attr.class "label noselect"] [Html.text model.label],
      ...
      Html.div [Attr.class "label noselect"] [Html.text (toString val)]
    ]
