		...
		switch (_p0.ctor) {
			...
			case 'Toggle':
				...
				var matrix = A2(
					...
					'matrix',
					A4(_user$project$Matrix$set, toggle, _p0._0, _p0._1, model.matrix));
...
var _user$project$DM$Model = F3(
	function (a, b, c) {
		return {width: a, height: b, matrix: c};
	});
...
var _user$project$DM$viewTransport = A2(
...
var _user$project$DM$viewRow = function (_p1) {
	var _p2 = _p1;
	var _p3 = _p2._0;
	var stepClass = function (val) {
...
var _user$project$DM$view = function (model) {
	var rows = A2(_elm_lang$core$List$map, _user$project$DM$viewRow, model.matrix.rows);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				rows),
				_user$project$DM$viewTransport
			]));
};
