	...
	function (msg, model) {
		...
		if (_p0.ctor === 'Play') {
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: _user$project$Ports$play(_p0._0)
			};
		} else {
			return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
var _user$project$DM$instruments = _elm_lang$core$Native_List.fromArray(
	['kick', 'snare', 'kick']);
var _user$project$DM$Model = F2(
	function (a, b) {
		return {width: a, height: b};
	});
var _user$project$DM$init = {
	ctor: '_Tuple2',
	_0: A2(_user$project$DM$Model, 0, 0),
...
var _user$project$DM$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second * 5, _user$project$DM$Tick);
};
...
var _user$project$DM$viewRow = F2(
	function (pos, instr) {
		var ypx = A2(
			...
			_elm_lang$core$Basics$toString(50 * pos),
			'px');
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$svg$Svg_Attributes$y(ypx),
					_elm_lang$svg$Svg_Attributes$width('40px'),
					_elm_lang$svg$Svg_Attributes$height('40px'),
					_elm_lang$html$Html_Events$onClick(
					_user$project$DM$Play(instr))
				]),
			_elm_lang$core$Native_List.fromArray(
				[]));
	});
var _user$project$DM$view = function (m) {
	var rows = A2(_elm_lang$core$List$indexedMap, _user$project$DM$viewRow, _user$project$DM$instruments);
	var bg = A2(
		_elm_lang$svg$Svg$rect,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$id('bg'),
				_elm_lang$svg$Svg_Attributes$x('0'),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$svg$Svg_Attributes$id('dm-app')
			]),
		A2(_elm_lang$core$List_ops['::'], bg, rows));
};
