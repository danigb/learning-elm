...
var _user$project$Metronome$toTime = F3(
	function (bpm, _p0, pos) {
		var _p1 = _p0;
		var _p2 = _p1._1;
		var subs = _elm_lang$core$Basics$toFloat((((pos.measure * _p1._0) + pos.beat) * _p2) + pos.sub);
		var len = 60 / (bpm * _elm_lang$core$Basics$toFloat(_p2));
		return len * subs;
	});
...
var _user$project$Metronome$position = F3(
	function (bpm, _p3, secs) {
		var _p4 = _p3;
		var _p5 = _p4._0;
		var len = 60 / (bpm * _elm_lang$core$Basics$toFloat(_p4._1));
		var subs = _elm_lang$core$Basics$floor(secs / len);
		var beats = (subs / 4) | 0;
		return A3(
			_user$project$Metronome$Pos,
			(beats / _p5) | 0,
			A2(_elm_lang$core$Basics_ops['%'], beats, _p5),
			A2(_elm_lang$core$Basics_ops['%'], subs, 4));
	});
var _user$project$Metronome$tick = F2(
	function (time, model) {
		var tickSecs = _elm_lang$core$Time$inSeconds(_elm_lang$core$Time$second / 30);
		var elapsed = _elm_lang$core$Time$inSeconds(
			time - A2(_elm_lang$core$Maybe$withDefault, time, model.startTime));
		var updated = function () {
			var _p6 = model.startTime;
			if (_p6.ctor === 'Nothing') {
...
var _user$project$Metronome$update = F2(
	function (msg, model) {
		...
		switch (_p7.ctor) {
			...
			case 'Tick':
				return A2(_user$project$Metronome$tick, _p7._0, model);
			case 'BpmChanged':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
			...
			default:
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{running: true, audioStartAt: _p8}),
					_1: _user$project$Ports$click(
						{ctor: '_Tuple2', _0: _p8, _1: 'high'})
				};
		}
	});
var _user$project$Metronome$Model = F6(
	function (a, b, c, d, e, f) {
		return {bpm: a, meter: b, running: c, startTime: d, audioStartAt: e, pos: f};
	});
